        ...
        <div className="pt-20 pb-128 md:pb-24 sm:mt32 mt-12 px-5 sm:px-24 gap-3 bg-linear-to-b from-[#0E1117]/0 via-[#0E1117]/80 to-[#2A1E3F]">
              ...
              {connections.map((contact) => (
                ...
                >
                  ...
                  <a
                    ...
                    className="group relative flex items-center px-2 py-2 rounded-2xl bg-white/2 border border-white/10 backdrop-blur-md transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1) hover:scale-105 hover:bg-white/[0.07] hover:border-purple-500/50 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4),0_0_20px_rgba(168,85,247,0.15)] overflow-hidden"
                  >
          ...
          <div className="flex align-center justify-left text-left flex-row gap-8 pt-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="relative lg:mt-4 mt-0 mb-28 lg:mb-24 w-fit px-5 py-2 text-center rounded-lg text-sm font-generalsans text-white overflow-hidden group inline-flex items-center justify-center font-bold transition-all duration-300 ease-out bg-linear-to-br from-purple-600 to-indigo-600 hover:scale-110 hover:rotate-1 active:scale-95 hover:shadow-[0_20px_50px_rgba(147,51,234,0.3)]"
              >
