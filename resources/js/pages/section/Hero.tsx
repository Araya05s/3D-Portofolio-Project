  ...
  return (
    <section id="home" className='min-h-screen flex flex-col relative'>
        <div className="absolute inset-0 pt-20 sm:mt36 mt-32 px-5 sm:px-24 gap-3 bg-linear-to-b from-[#0E1117]/0 via-[#0E1117]/80 to-[#2A1E3F]">
          ...
          <div>
            <Fade duration={500}>
              <h1 className="lg:mt-12 mt-6 sm:text-3xl text-xl text-white font-bold lg:text-left text-center underline decoration-purple-500 decoration-4 underline-offset-8 font-generalsans">{title}</h1>
            </Fade>
          ...
          <div className="hidden lg:block w-4xl h-full absolute right-0 top-0">
          ...
          <div className="visible lg:hidden w-full h-full absolute inset-0">
            <Canvas className="w-full h-full">
              <Suspense fallback={<CanvasLoader />}>
                ...
                <IntroModel position={[0, -4, 5]} rotation={[15, 60, 0]} scale={isMobile? 5.0 : 6.5}/>
              </Suspense>
            </Canvas>
          </div>
        </div>
